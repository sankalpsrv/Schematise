...
import re
def csv_parser(filename, start_value=70, end_value=73):

    csv_filename = filename # file containing all the sections from the E-Waste Rules, generated via IK_interface function
    ...
    if df_condition == "1":
        df2 = df.iloc[start_value:end_value]
    else:
        df2=df.copy()
